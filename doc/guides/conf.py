...
version = 'Latest' #subprocess.check_output(['make', '-sRrC', '../../', 'showversion'],
...
def setup(app):
    ...
    try:
        ...
        # Sphinx 1.8 changes add_stylesheet to add_css_file
