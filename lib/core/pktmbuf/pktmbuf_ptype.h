 ...
 *
 * This file contains declarations for features related to pktmbuf packet
 * types. The packet type gives information about the data carried by the
 * pktmbuf, and is stored in the pktmbuf in a 32 bits field.
 *
 ...
 *
 * To be compatible with Vector PMD, CNE_PTYPE_L3_IPV4, CNE_PTYPE_L3_IPV4_EXT,
 * CNE_PTYPE_L3_IPV6, CNE_PTYPE_L3_IPV6_EXT, CNE_PTYPE_L4_TCP, CNE_PTYPE_L4_UDP
 * and CNE_PTYPE_L4_SCTP should be kept as below in a contiguous 7 bits.
 *
 * Note that L3 types values are selected for checking IPV4/IPV6 header from
 * performance point of view. Reading annotations of CNE_ETH_IS_IPV4_HDR and
 * CNE_ETH_IS_IPV6_HDR is needed for any future changes of L3 type values.
 *
 ...
 * CNE_PTYPE_L2_ETHER |
 * CNE_PTYPE_L3_IPV4_EXT_UNKNOWN |
 * CNE_PTYPE_TUNNEL_IP |
 * CNE_PTYPE_INNER_L3_IPV6_EXT_UNKNOWN |
 * CNE_PTYPE_INNER_L4_ICMP.
 *
 * <'ether type'=0x86DD
 ...
 * will be recognized on i40e hardware as packet type combination of,
 * CNE_PTYPE_L2_ETHER |
 * CNE_PTYPE_L3_IPV6_EXT_UNKNOWN |
 * CNE_PTYPE_TUNNEL_GRENAT |
 * CNE_PTYPE_INNER_L3_IPV6_EXT_UNKNOWN |
 * CNE_PTYPE_INNER_L4_UDP.
 */
 ...
 * (CNE_PTYPE_L4_TCP, CNE_PTYPE_L4_UDP, CNE_PTYPE_L4_SCTP, CNE_PTYPE_L4_ICMP,
 * CNE_PTYPE_L4_NONFRAG).
 *
 * Packet format:
 * <'ether type'=0x0800
 * | 'version'=4, 'MF'=1>
 ...
 * any of above L4 types (CNE_PTYPE_L4_TCP, CNE_PTYPE_L4_UDP,
 * CNE_PTYPE_L4_FRAG, CNE_PTYPE_L4_SCTP, CNE_PTYPE_L4_ICMP).
 *
 * Packet format:
 * <'ether type'=0x0800
...
#define CNE_ETH_IS_TUNNEL_PKT(ptype)                                                        \
    ((ptype) & (CNE_PTYPE_TUNNEL_MASK | CNE_PTYPE_INNER_L2_MASK | CNE_PTYPE_INNER_L3_MASK | \
