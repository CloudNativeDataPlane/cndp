...
static void
__pcb_show(struct pcb_entry *pcb)
{
...
static void
__pcb_iterate(mempool_t *mp __cne_unused, void *obj_cb_arg __cne_unused, void *obj,
              unsigned n __cne_unused)
{
    __pcb_show((struct pcb_entry *)obj);
}
...
_pcb_dump(stk_t *stk)
{
    ...
    mempool_obj_iter(stk->pcb_objs, __pcb_iterate, NULL);
}
