 ...
 */
typedef int (*close_func_t)(int cd);
typedef int (*send_func_t)(int cd, pktmbuf_t **mbufs, uint16_t nb_mbufs);
typedef int (*recv_func_t)(int cd, pktmbuf_t **mbufs, int nb_mbufs);
typedef int (*bind_func_t)(int cd, struct in_caddr *pAddr, int len);
typedef int (*connect_func_t)(int cd, struct in_caddr *to, int slen);
typedef int (*shutdown_func_t)(int cd, int how);
typedef int (*accept_func_t)(int cd, struct in_caddr *addr, int *addrlen);
typedef int (*listen_func_t)(int cd, int backlog);
