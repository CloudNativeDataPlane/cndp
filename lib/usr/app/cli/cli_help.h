...
#include "cli_map.h"           // for cli_map
#include "cne_common.h"        // for CNDP_API

// IWYU pragma: no_forward_declare cli_map
struct cli_map;
 ...
 * @param group
 *   The group string for this command
 * @param argc
 *   Number or arguments in the *argv* array
 * @param argv
 *   The array of string pointers for the command line.
 * @return
 *   0 on success or -1 on error
 */
