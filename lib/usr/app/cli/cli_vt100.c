...
#include <string.h>        // for strlen, strncmp, strndup, strnlen
#include <stdlib.h>        // for free, calloc
#include <stdio.h>         // for NULL, size_t

#include "cli.h"              // for cli, this_cli, cli_set_flag, cli_execute
#include "cli_input.h"        // for cli_clear_line, cli_cursor_left, cli_...
#include "cli_vt100.h"
#include "cli_auto_complete.h"        // for cli_auto_complete
#include "cli_gapbuf.h"               // for gb_point_at_start, gb_reset_buf, gb_r...
#include "cli_history.h"              // for cli_history_next, cli_history_prev
...
key_ctrl_a(void)
{
    cne_printf(vt100_multi_left, gb_left_data_size(this_cli->gb));
...
key_ctrl_e(void)
{
    cne_printf(vt100_multi_right, gb_right_data_size(this_cli->gb));
