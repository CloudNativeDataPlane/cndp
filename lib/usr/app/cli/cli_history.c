...
#include <sys/queue.h>        // for CIRCLEQ_EMPTY, CIRCLEQ_FIRST, CIRCLEQ_LAST
#include <stdlib.h>           // for NULL, free, malloc, size_t
// IWYU pragma: no_include <cli_history.h>

#include "cli.h"                // for cli, this_cli
#include "cli_history.h"        // for cli_hist, cli_hist::(anonymous), cli_hist_a...
