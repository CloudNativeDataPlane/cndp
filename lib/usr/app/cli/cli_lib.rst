...
Development Kit (CNDP). The CLI is a workalike replacement for cmdline library
in CNDP and has a simpler interface and programming model plus it is dynamic.
