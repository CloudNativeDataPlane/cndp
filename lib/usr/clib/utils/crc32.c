...
static uint32_t
crc32c_sb8_64_bit(uint32_t crc, const unsigned char *p_buf, uint32_t length, uint32_t init_bytes)
{
    uint32_t li;
...
static uint32_t
multitable_crc32c(uint32_t crc32c, const unsigned char *buffer, unsigned int length)
{
