 ...
 *  False (0) otherwise.
 */
int ether_addr_is_same(const struct ether_addr *ea1, const struct ether_addr *ea2);
 ...
 *   false (0) otherwise.
 */
int ether_addr_is_zero(const struct ether_addr *ea);
 ...
 *   false (0) otherwise.
 */
int ether_addr_is_unicast(const struct ether_addr *ea);
 ...
 *   false (0) otherwise.
 */
int ether_addr_is_multicast(const struct ether_addr *ea);
 ...
 *   false (0) otherwise.
 */
int ether_addr_is_broadcast(const struct ether_addr *ea);
 ...
 *   false (0) otherwise.
 */
int ether_addr_is_universal(const struct ether_addr *ea);
 ...
 *   false (0) otherwise.
 */
int ether_addr_is_local_admin(const struct ether_addr *ea);
 ...
 *   false (0) otherwise.
 */
int ether_addr_is_valid_assigned(const struct ether_addr *ea);
 ...
 */
void ether_random_addr(uint8_t *addr);
 ...
 */
void ether_addr_copy(const struct ether_addr *ea_from, struct ether_addr *ea_to);
 ...
 */
void ether_format_addr(char *buf, uint16_t size, const struct ether_addr *eth_addr);
/**
...
int ether_unformat_addr(const char *str, struct ether_addr *eth_addr);
