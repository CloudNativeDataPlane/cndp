...
static const cne_ymm_t _SC_(match_mask) = {
    .u32 =
        {
            CNE_ACL_NODE_MATCH,
            CNE_ACL_NODE_MATCH,
...
static const cne_ymm_t _SC_(index_mask) = {
    .u32 =
        {
            CNE_ACL_NODE_INDEX,
            CNE_ACL_NODE_INDEX,
...
static const cne_ymm_t _SC_(trlo_idle) = {
    .u32 =
        {
            CNE_ACL_IDLE_NODE,
            CNE_ACL_IDLE_NODE,
...
// clang-format off
static const cne_ymm_t _SC_(trhi_idle) = {
    .u32 = {
            0, 0, 0, 0,
            0, 0, 0, 0,
        },
...
static const cne_ymm_t _SC_(shuffle_input) = {
    .u32 = {
...
static const cne_ymm_t _SC_(four_32) = {
    .u32 = {
		4, 4, 4, 4,
		4, 4, 4, 4,
        },
...
static const cne_ymm_t _SC_(idx_add) = {
    .u32 = {
		0, 1, 2, 3,
		4, 5, 6, 7,
        },
...
static const cne_ymm_t _SC_(range_base) = {
    .u32 = {
...
static const cne_ymm_t _SC_(pminp) = {
    .u32 = {
		0x00, 0x01, 0x02, 0x03,
		0x08, 0x09, 0x0a, 0x0b,
        },
...
static const cne_ymm_t _SC_(pmidx[2]) = {
    [0] = {
            .u32 = {
                0, 0, 1, 0, 2, 0, 3, 0,
                },
 ...
 */
static __cne_always_inline __m256i
_F_(gather_bytes)(__m256i zero, const __m256i p[2], const uint32_t m[2], uint32_t bnum)
{
    __m128i inp[2];
    ...
    if (bnum == sizeof(uint8_t)) {
        ...
        inp[0] = _mm256_mmask_i64gather_epi32(_mm256_castsi256_si128(zero), m[0], p[0], NULL,
                                              sizeof(uint8_t));
        inp[1] = _mm256_mmask_i64gather_epi32(_mm256_castsi256_si128(zero), m[1], p[1], NULL,
                                              sizeof(uint8_t));
    }
 ...
 */
static inline int
search_avx512x8x2(const struct cne_acl_ctx *ctx, const uint8_t **data, uint32_t *results,
